...
// SingletonReader is an autogenerated mock type for the SingletonReader type
type SingletonReader struct {
	mock.Mock
}

// GetSingleton provides a mock function with given fields:
func (_m *SingletonReader) GetSingleton() (*accountpoolmetrics.AccountPoolMetrics, error) {
	ret := _m.Called()
